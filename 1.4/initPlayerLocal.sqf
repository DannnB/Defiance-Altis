...
switch (CIV_POP) do
{
    ...
    {
    	[5,150,15,2,4,MAX_CIV_DEATH,CIV_DEATH_PEN,30,15,1] execvm "scripts\tpw_civs.sqf";
		[5,900,15,2,1] execvm "scripts\tpw_cars.sqf";
		[0,1000,15,0] execvm "scripts\tpw_boats.sqf";
		[0,300,150,20,10] execvm "scripts\tpw_park.sqf";
...
[] spawn {
	while {true} do
	{
		...
		systemChat "Join our Teamspeak | riotcontrol.ts.nfoservers.com";
		sleep 5;
		systemChat "www.riotcontrolgaming.com";
		sleep 1000;
	};
};
