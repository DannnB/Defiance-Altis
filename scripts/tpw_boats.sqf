...
tpw_boat_version = "1.23"; // Version string
...
tpw_boat_fnc_spawnboat =
	...
	// NASH
	(leader _sqname) addAction["Question Local", "scripts\nash_interviewciv.sqf", nil, 6, True, True, "", "(_target distance _this) < 4 && alive _target"];
	(leader _sqname) addAction["Halt!", "scripts\nash_halt.sqf", nil, 6, True, True, "", "alive _target"];
	// END NASH
	...
	if (random 10 < 5) then
		...
		_passenger addAction["Question Local", "scripts\nash_interviewciv.sqf", nil, 6, True, True, "", "(_target distance _this) < 4 && alive _target"];
		_passenger addAction["Halt!", "scripts\nash_halt.sqf", nil, 6, True, True, "", "alive _target"];
		//END NASH EDITS
