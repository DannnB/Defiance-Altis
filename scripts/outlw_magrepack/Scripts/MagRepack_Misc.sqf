...
outlw_MR_getIDCs =
{
	private ["_config","_ctrlCount","_returnList","_ctrl","_filter"];
...
{
	private ["_listIDCs","_ctrlCount","_returnBool","_idc"];
...
outlw_MR_magInfo =
{
	private ["_magsAmmo","_magTypes","_magAmmoCounts","_magAmmoCaps","_magType","_a"];
...
outlw_MR_removeMag =
{
	private ["_toRemove","_ammoCount","_magInfo"];
