...
//Changelog:"I_Heli_light_03_unarmed_F","I_Heli_light_03_F" added by -[EUTW]-jrog

// to use add to init.sqf: [] call compileFinal PreProcessFile "scripts\zlt_fastrope.sqf";
...
zlt_rope_helidata = 
[
[["O_Heli_Light_02_unarmed_F", "O_Heli_Light_02_F"], [1.35,1.35,-24.95],[-1.45,1.35,-24.95]],
...
[["I_Heli_light_03_unarmed_F","I_Heli_light_03_F"], [0.50,2.35,-25.75],[0.50,2.35,-25.75]]
];
...
zlt_fnc_tossropes = {
    private ["_heli","_ropes","_oropes","_rope","_i"];
    _heli = _this;
    _ropes = [];
